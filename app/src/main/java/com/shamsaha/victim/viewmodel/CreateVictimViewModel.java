...
public class CreateVictimViewModel extends ViewModel {

    public MutableLiveData<CheckDeviceWithPhoneModel> createVictimMutableLiveData;

    public MutableLiveData<CheckDeviceWithPhoneModel> getCreateVictim(String deviceId,String phoneNumber, FragmentActivity activity){
        if(createVictimMutableLiveData == null){
            createVictimMutableLiveData = new MutableLiveData<>();
            createVictim(deviceId,phoneNumber,activity);
        }


        return createVictimMutableLiveData;
    }


    private void createVictim(String deviceId, String phoneNumber,FragmentActivity activity) {
        ...
        Call<CheckDeviceWithPhoneModel> call = apiService.CREATE_VICTIM_MODEL_CALL(deviceId,phoneNumber);
        call.enqueue(new Callback<CheckDeviceWithPhoneModel>() {
            ...
            public void onResponse(Call<CheckDeviceWithPhoneModel> call, Response<CheckDeviceWithPhoneModel> response) {
                if (response.isSuccessful()) {
                    ...
                    createVictimMutableLiveData.setValue(checkDeviceWithPhoneModel);
