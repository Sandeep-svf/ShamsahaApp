...
public class NewSplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // Glide.with(SplashActivity.this).load(R.drawable.logo_final).into(splashscreen);
        Glide.with(NewSplashActivity.this).load(R.drawable.ic_continue_credentials).into(splashscreen2);
    ...
    private void internetStatusCheck() {
        Log.e("CHECK","A");
        ConnectivityManager connectivityManager = (ConnectivityManager) NewSplashActivity.this.getSystemService(Context.CONNECTIVITY_SERVICE);
        ...
        Snackbar snackbar = Snackbar.make(rlBaseLayout, "Please Connect Internet Connection  ?", Snackbar.LENGTH_INDEFINITE)
                .setAction("RETRY", new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        NewSplashActivity.this.internetStatusCheck();
                    }
                });
...
//            SplashActivity.this.finish();
            ...
            if(UserID.equals(""))
            {
                ...
                Intent intent=new Intent(NewSplashActivity.this, MobileNumberAuthActivity.class);
                startActivity(intent);
                finish();
            }
            else
            {
                Intent intent=new Intent(NewSplashActivity.this, DashboardVictimActivity.class);
                startActivity(intent);
                finish();
            }
        }
